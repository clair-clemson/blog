...
<div style="text-align:center; display:flex; flex-wrap:wrap; justify-content:center; gap:24px;">

  <figure style="max-width:700px; margin:0;">
    <img 
    ...
    <figcaption>
      <em>
        ...
        Effect of &lambda; on basis diversity and reconstruction on the Zoo dataset.
        Other datasets follow similarly. Increasing &lambda; reduces positive basis correlations.
      </em>
    </figcaption>
  </figure>
  ...
  <figure style="max-width:700px; margin:0;">
    ...
    <figcaption>
      <em>
        ...
        Heatmap of the learned coefficient matrix <strong>G</strong> on the Wine data set.
      </em>
    </figcaption>
  </figure>
  ...
  <figure style="max-width:700px; margin:0;">
    ...
    <figcaption>
      <em>
        ...
        for updating the simplex-constrained coefficient matrix <strong>G</strong>.
      </em>
    </figcaption>
  </figure>
